...
$(function(){$("#my-menu").mmenu({extensions:["widescreen","theme-black","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/wooder.png">'}}),$("#my-menu").data("mmenu").bind("opened",function(){$(".hamburger").addClass("is-active")}).bind("closed",function(){$(".hamburger").removeClass("is-active")})}),$(".dots a").mPageScroll2id(),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top_button").addClass("active"):$(".top_button").removeClass("active")}),$(".top_button").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),(new WOW).init(),document.body.onload=function(){setTimeout(function(){var e=document.getElementById("page-preloader");e.classList.contains("done")||e.classList.add("done")},1e3)};